...
# This script downloads and installs the latest Office Excel 2016 for compatible Macs
...
# Specify the complete address of the SKUless Office 2016 Excel Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=525135"

# Specify name of downloaded disk image

installer_pkg="/tmp/excelinstaller.pkg"
