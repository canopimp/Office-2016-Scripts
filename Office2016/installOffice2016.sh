...
# This script downloads and installs the latest Office 2016 for compatible Macs
...
# Specify the complete address of the SKUless Office Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=525133"
...
if [[ ${osvers} -ge 10 ]]; then
    ...
    ## curl --output /tmp/officeinstaller.pkg https://go.microsoft.com/fwlink/?linkid=525133
