...
# This script downloads and installs the latest Office Outlook 2016 for compatible Macs
...
# Specify the complete address of the SKUless Office 2016 Outlook Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=525137"

# Specify name of downloaded disk image

installer_pkg="/tmp/outlookinstaller.pkg"
