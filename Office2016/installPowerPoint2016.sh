...
# This script downloads and installs the latest Office PowerPoint 2016 for compatible Macs
...
# Specify the complete address of the SKUless Office 2016 PowerPoint Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=525136"

# Specify name of downloaded disk image

installer_pkg="/tmp/powerpointinstaller.pkg"
