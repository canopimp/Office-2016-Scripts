...
# This script downloads and installs the latest Office Skype for Business 2016 for compatible Macs
...
# Specify the complete address of the Skype For Business Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=832978"

# Specify name of downloaded disk image

installer_pkg="/tmp/s4binstaller.pkg"
