...
# This script downloads and installs the latest Office WORD 2016 for compatible Macs
...
# Specify the complete address of the SKUless Office 2016 Word Installer
# installer package

installerURL="https://go.microsoft.com/fwlink/?linkid=525134"

# Specify name of downloaded disk image

installer_pkg="/tmp/wordinstaller.pkg"
